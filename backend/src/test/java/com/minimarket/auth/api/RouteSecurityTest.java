...
class RouteSecurityTest {
  ...
  private static final Set<Route> API_ROUTES =
      Set.of(
          ...
          new Route("POST", "/api/v1/products/{id}/disable"),
          new Route("POST", "/api/v1/products/{id}/enable"),
          ...
          new Route("PUT", "/api/v1/sales/{id}/discount"),
          new Route("DELETE", "/api/v1/sales/{id}/discount"),
          new Route("PUT", "/api/v1/sales/{id}/customer"),
          new Route("DELETE", "/api/v1/sales/{id}/customer"),
          new Route("POST", "/api/v1/sales/{id}/cancel"),
          new Route("POST", "/api/v1/sales/{id}/complete"),
