 ...
 * do movimento, e a sangria gravaria dinheiro saindo de uma sessão já fechada, fora da conta do
 * {@code expected_amount} (o cenário 3 do passo 613 mostrou a janela). Sessão que não está mais
 * aberta sob o lock é o mesmo 404, sem gravar nada.
 *
