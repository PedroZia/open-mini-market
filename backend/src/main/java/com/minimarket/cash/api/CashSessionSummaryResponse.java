 ...
 * differenceAmount} são nulos enquanto a sessão está aberta. A projeção {@code
 * CashSessionSummaryView} de {@code application} é mapeada para cá; entidade JPA nunca vai a JSON.
 */
