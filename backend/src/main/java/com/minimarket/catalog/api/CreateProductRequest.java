 ...
 * de unidade ({@code UN}/{@code KG}), a normalização do barcode e a existência da categoria ficam
 * no caso de uso — fonte única da regra — e não se repetem aqui. {@code barcode}, {@code
 * description}, {@code categoryId} e {@code minQuantity} são opcionais; loja e estado ativo nunca
 * vêm do cliente.
 *
